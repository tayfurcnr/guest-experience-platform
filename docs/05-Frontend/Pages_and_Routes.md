...
- Kanonik şube URL formatı nested path'tir; tek bir şube slug'ı path segmenti olarak taşınır.
...
- Marka kartı
- Şube kartı
- Platform keşif grid'i
- Mağaza oluşturma wizard'ı
- Tema özelleştirme paneli
- Staff / role yönetim tablosu
- Campaign planlayıcı
- Kategori listesi
- Ürün kartı
